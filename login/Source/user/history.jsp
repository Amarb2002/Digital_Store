...
<body>
    ...
    <div class="booking-container">
        ...
        <div class="booking-card">
            <img src="assets/img/digiasset/<%=rs.getString("s_image") %>" alt="Image description">
            <div class="booking-details">
                <div class="booking-date">
                    20/20/20 <!-- Assuming you have booking_date in your result set -->
        </div>
                ...
                <a href="#" class="booking-status"><%= status %></a>
            </div>
        </div>
        <%
                }
