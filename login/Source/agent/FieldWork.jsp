...
<body>
    ...
    <div class="booking-container">
        ...
        // if (rs2.next()) {
            ...
            ResultSet rs1 = s1.stm.executeQuery("SELECT * FROM booking WHERE status='booked'");
            while (rs1.next()) {
                count++;
                ...
                while (rs.next()){
                    ...
                    int statusIndex = 0;
                     ResultSet rs2 = s.stm.executeQuery("SELECT * FROM users WHERE u_id='" + u_id + "'");
                     if(rs2.next()){
        ...
        <div class="booking-card">
            <img src="assets/img/testimonials/<%=rs2.getString("u_image") %>" alt="Image description">
            <div class="booking-details">
                <div class="booking-date">
                    <%=rs1.getString("b_date") %> <!-- Assuming you have booking_date in your result set -->
        </div>
                <h2 style="font-size: 25px;" class="service-name"><%= rs2.getString("name") %></h2>

                <p class="service-description"><b>Request For</b> <%= rs.getString("s_name") %></p>
