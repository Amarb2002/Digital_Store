			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="agent_reg.jsp" method="post" class="signin-form">
					...
					<div class="form-group">
		      			<input type="text" autocomplete="off" name="phone" class="form-control" placeholder="Mobile No" required>
		      		</div>
					
					<div class="form-group">
		      			<input type="text" autocomplete="off" name="email" class="form-control" placeholder="Email ID." required>
		      		</div>
					
					<div class="form-group">
		      			<input type="text" autocomplete="off" name="address" class="form-control" placeholder="Full Address" required>
		      		</div>
		      			<div class="form-group">
		      			<input type="text" autocomplete="off" name="question" class="form-control" placeholder="Enter Qustion" required>
		      		</div>
		      		<div class="form-group">
		      			<input type="text" autocomplete="off" name="answer" class="form-control" placeholder="Enter Answer" required>
		      		</div>
